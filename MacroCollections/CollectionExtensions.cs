...
namespace MacroCollections
{
    public static class CollectionExtensions
    {
        ...
        /// </returns>
        ///
        public static int IndexOf<T>(this IEnumerable<T> sequence, Predicate<T> criteria)
        {
        ...
        /// </exception>
        ///
        public static void Insert<T>(this IList<T> list, int index, T item, params T[] moreItems)
        {
        ...
        /// </summary>
        ///
        public static void Add<T>(this ICollection<T> collection, T item, params T[] moreItems)
        {
